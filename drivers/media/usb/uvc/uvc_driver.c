		...
		u8 epaddr)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_find_endpoint 0\n");
...
{
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_format_by_guid 0\n");
...
static enum v4l2_colorspace uvc_colorspace(const u8 primaries)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_colorspace 0\n");
...
static enum v4l2_xfer_func uvc_xfer_func(const u8 transfer_characteristics)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_xfer_func 0\n");
...
static enum v4l2_ycbcr_encoding uvc_ycbcr_enc(const u8 matrix_coefficients)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_ycbcr_enc 0\n");
		...
		unsigned int n_terms, unsigned int threshold)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_simplify_fraction 0\n");
...
u32 uvc_fraction_to_interval(u32 numerator, u32 denominator)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_fraction_to_interval 0\n");
...
struct uvc_entity *uvc_entity_by_id(struct uvc_device *dev, int id)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_entity_by_id 0\n");
	...
	int id, struct uvc_entity *entity)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_entity_by_reference 0\n");
...
static struct uvc_streaming *uvc_stream_by_id(struct uvc_device *dev, int id)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_stream_by_id 0\n");
...
static void uvc_stream_delete(struct uvc_streaming *stream)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_stream_delete 0\n");
					    ...
					    struct usb_interface *intf)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_stream_new 0\n");
	...
	u32 **intervals, unsigned char *buffer, int buflen)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_format: dev->udev->devnum: %d, buflen: %d\n", dev->udev->devnum, buflen);
	...
	case UVC_VS_FORMAT_UNCOMPRESSED:
		printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_format: UVC_VS_FORMAT_UNCOMPRESSED\n");
	case UVC_VS_FORMAT_FRAME_BASED:
		printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_format: UVC_VS_FORMAT_FRAME_BASED\n");
	...
	case UVC_VS_FORMAT_MJPEG:
		printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_format: UVC_VS_FORMAT_MJPEGn");
		if (buflen < 11) {
			uvc_dbg(dev, DESCR,
				"device %d videostreaming interface %d FORMAT error\n",
				dev->udev->devnum,
	...
	case UVC_VS_FORMAT_DV:
		printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_format: UVC_VS_FORMAT_DV");
		if (buflen < 9) {
			uvc_dbg(dev, DESCR,
				"device %d videostreaming interface %d FORMAT error\n",
				dev->udev->devnum,
	...
	case UVC_VS_FORMAT_MPEG2TS:
		printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_format: UVC_VS_FORMAT_MPEG2TS");
	case UVC_VS_FORMAT_STREAM_BASED:
		printk(KERN_INFO "!!!dgnet: uvc_driver.c: UVC_VS_FORMAT_STREAM_BASED");
		/* Not supported yet. */
	default:
		printk(KERN_INFO "!!!dgnet: uvc_driver.c: UNSUPPORTED FORMAT");
		uvc_dbg(dev, DESCR,
	...
	while (buflen > 2 && buffer[1] == USB_DT_CS_INTERFACE &&
		...
		printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_format: frame->wWidth: %d, frame->wHeight: %d\n", frame->wWidth, frame->wHeight );
		...
		if (ftype != UVC_VS_FRAME_FRAME_BASED) {
			...
			printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_format: frame type: FRAME_BASED\n");
			...
			printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_format: frame type: NOT FRAME_BASED\n");
		...
		printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_format: frame->dwMaxVideoFrameBufferSize 1: %d\n",frame->dwMaxVideoFrameBufferSize);
		...
		if (!(format->flags & UVC_FMT_FLAG_COMPRESSED)){
			...
			printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_format: !(format->flags & UVC_FMT_FLAG_COMPRESSED) \n");
		...
		printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_format: frame->dwMaxVideoFrameBufferSize 2: %d\n",frame->dwMaxVideoFrameBufferSize);
	...
	struct usb_interface *intf)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_streaming 0\n");
		...
		unsigned int num_pads, unsigned int extra_size)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_alloc_entity 0\n");
	...
	const unsigned char *buffer, int buflen)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_vendor_control 0\n");
	...
	const unsigned char *buffer, int buflen)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_standard_control 0\n");
...
static int uvc_parse_control(struct uvc_device *dev)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_parse_control 0\n");
...
static void uvc_gpio_event(struct uvc_device *dev)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_gpio_event 0\n");
			    ...
			    u8 cs, void *data, u16 size)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_gpio_get_cur 0\n");
			     ...
			     u8 cs, u8 *caps)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_gpio_get_info 0\n");
...
static irqreturn_t uvc_gpio_irq(int irq, void *data)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_gpio_irq 0\n");
...
static int uvc_gpio_parse(struct uvc_device *dev)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_gpio_parse 0\n");
...
static int uvc_gpio_init_irq(struct uvc_device *dev)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_gpio_init_irq 0\n");
	...
	struct uvc_entity *entity)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_scan_chain_entity 0\n");
	...
	struct uvc_entity *entity, struct uvc_entity *prev)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_scan_chain_forward 0\n");
	...
	struct uvc_entity **_entity)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uuvc_scan_chain_backward 0\n");
			  ...
			  struct uvc_entity *term)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_scan_chain 0\n");
		...
		char *buffer)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_print_terms 0\n");
...
static const char *uvc_print_chain(struct uvc_video_chain *chain)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_print_chain 0\n");
...
static struct uvc_video_chain *uvc_alloc_chain(struct uvc_device *dev)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_alloc_chain 0\n");
...
static int uvc_scan_fallback(struct uvc_device *dev)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_scan_fallback 0\n");
...
static int uvc_scan_device(struct uvc_device *dev)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_scan_device 0\n");
...
static void uvc_delete(struct kref *kref)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_delete 0\n");
...
static void uvc_release(struct video_device *vdev)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_release 0\n");
...
static void uvc_unregister_video(struct uvc_device *dev)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_unregister_video 0\n");
			      ...
			      const struct v4l2_ioctl_ops *ioctl_ops)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_register_video_device 0\n");
		...
		struct uvc_streaming *stream)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_register_video 0\n");
	...
	struct uvc_video_chain *chain)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_register_terms 0\n");
...
static int uvc_register_chains(struct uvc_device *dev)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_register_chains 0\n");
		     ...
		     const struct usb_device_id *id)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_probe 0\n");
...
static void uvc_disconnect(struct usb_interface *intf)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_disconnect 0\n");
...
static int uvc_suspend(struct usb_interface *intf, pm_message_t message)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_suspend 0\n");
...
static int __uvc_resume(struct usb_interface *intf, int reset)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: __uvc_resume 0\n");
...
{
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_resume 0\n");
...
{
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_reset_resume 0\n");
...
static int uvc_clock_param_get(char *buffer, const struct kernel_param *kp)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_clock_param_get 0\n");
...
static int uvc_clock_param_set(const char *val, const struct kernel_param *kp)
{
	...
	printk(KERN_INFO "!!!dgnet: uvc_driver.c: uvc_clock_param_set 0\n");
