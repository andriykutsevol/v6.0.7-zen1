		...
		int non_blocking, int intr)
{
	...
	printk(KERN_INFO "!!!dgnet: videobuf-core.c: ideobuf_waiton 0\n");
...
int videobuf_querybuf(struct videobuf_queue *q, struct v4l2_buffer *b)
{
	...
	printk(KERN_INFO "!!!dgnet: videobuf-core.c: videobuf_querybuf 0\n");
...
static int __videobuf_read_start(struct videobuf_queue *q)
{
	...
	printk(KERN_INFO "!!!dgnet: videobuf-core.c: __videobuf_read_start 0\n");
